...
export enum FichierSource {
  ...
  DIAMANT_ANN_ERRD_EJ_ET = 'diamant_ann_errd_ej_et',
  DIAMANT_ANN_MS_TDP_ET = 'diamant_ann_ms_tdp_et',
  DIAMANT_MEN_PMSI_ANNUEL = 'diamant_men_pmsi_annuel',
  DIAMANT_ANN_RPU = 'diamant_ann_rpu',
}
