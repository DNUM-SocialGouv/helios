...
export class UpdateInstitutionsTable1704363653168 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        // create back-up r-------------------------------
        await queryRunner.query("create table utilisateur_old as select * from utilisateur;");
        await queryRunner.query("create table institution_old as select * from institution;");
