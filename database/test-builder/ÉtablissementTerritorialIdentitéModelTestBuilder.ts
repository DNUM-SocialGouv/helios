...
export class ÉtablissementTerritorialIdentitéModelTestBuilder {
  public static créeMédicoSocial(
    ...
    établissementTerritorialModel.codeModeTarification = champsSurchargés?.codeModeTarification || '99'
    ...
    établissementTerritorialModel.libelléModeTarification = champsSurchargés?.libelléModeTarification || 'Indéterminé'
    ...
    établissementTerritorialModel.siret = champsSurchargés?.siret || '20003004700017'
  ...
  public static créeSanitaire(
    ...
    établissementTerritorialModel.codeModeTarification = champsSurchargés?.codeModeTarification || '54'
    ...
    établissementTerritorialModel.libelléCatégorieÉtablissement = champsSurchargés?.libelléCatégorieÉtablissement || 'Centre Hospitalier (C.H.)'
    établissementTerritorialModel.libelléCourtCatégorieÉtablissement = champsSurchargés?.libelléCourtCatégorieÉtablissement || 'C.H.'
    établissementTerritorialModel.libelléModeTarification = champsSurchargés?.libelléModeTarification || 'Tarif AM - Services de Soins Infirmiers A Domicile'
    ...
    établissementTerritorialModel.siret = champsSurchargés?.siret || '20003004700018'
