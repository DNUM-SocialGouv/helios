...
describe("isFeatureEnabled", () => {
  ...
  it("doit toujours renvoyer true si on bypass le feature toggle via une query", () => {
    // GIVEN
    const isFeatureEnabled = buildFeatureToggleConfig([FEATURE_NAME.COMPTE_RESULTAT_EJ], [])({ feature_toggle: "off" });
