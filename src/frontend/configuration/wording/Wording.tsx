...
export interface Wording {
  ...
  readonly TAUX_OCCUPATION_HÉBERGEMENT_ACCUEIL_DE_JOUR: string
  readonly TAUX_RÉALISATION_ACTIVITÉ: string
  readonly FILE_ACTIVE_PERSONNES_ACCOMPAGNÉES_SUR_PERIODE: string
  readonly NOMBRE_MOYEN_JOURNÉE_ABSENCE_PERSONNES_ACCOMPAGNÉES_SUR_PERIODE: string
  readonly DURÉE_MOEYNNE_SÉJOUR_ACCOMPAGNEMENT_PERSONNES_SORTIES: string
