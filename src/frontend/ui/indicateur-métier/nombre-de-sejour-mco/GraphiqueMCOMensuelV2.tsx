...
export const GraphiqueNombreDeSejourMCOMensuelV2 = ({ nombreDeSejourMCOViewModel, estEntitéJuridique = false }: GraphiqueNombreDeSejourMCOProps) => {
    const { wording } = useDependencies();
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    const [annéeEnCours, setAnnéeEnCours] = useState<number>(2022);
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    const [moisDeDébut, setMoisDeDébut] = useState<string>("janvier");
    ...
    return (
        ...
        >
            <HistogrammeVerticalABandes
                ...
                data={nombreDeSejourMCOViewModel.getHistogrammeMensuelV2DataSet(moisDeDébut)}
                id="légende-graphique-sanitaire-journées-séjours-mco-mensuel-v2"
                idDeLaLégende="légende-graphique-sanitaire-journées-séjours-mco-mensuel-v2"
