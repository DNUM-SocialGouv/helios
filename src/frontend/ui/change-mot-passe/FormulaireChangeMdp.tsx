...
export const FormulaireChangeMdp = ({ changePassword, annuler, passwordValueOnChange, confirmPasswordValueOnChange, passwordValue, confirmPasswordValue, errorMessage }: FormulaireChangeMdpProps) => {
