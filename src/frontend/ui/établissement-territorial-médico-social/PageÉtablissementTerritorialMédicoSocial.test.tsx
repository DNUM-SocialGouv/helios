...
describe('La page Établissement territorial', () => {
  ...
  it('affiche l’indicateur de mono-établissement dans le bloc identité', () => {
    ...
    const établissementTerritorialMonoÉtablissement =
      ÉtablissementTerritorialMédicoSocialViewModelTestFactory.crée(wording, { estMonoÉtablissement: true })
  ...
  describe('l’indicateur d’établissement principal ou secondaire dans le bloc identité', () => {
    it('affiche "Principal" si l’établissement est un établissement principal', () => {
      // GIVEN
      const établissementTerritorialPrincipal = ÉtablissementTerritorialMédicoSocialViewModelTestFactory.crée(wording, { typeÉtablissement: 'P' })
  ...
  describe('affiche "non renseigné" quand une valeur est vide', () => {
    it('pour le téléphone', () => {
      const établissementTerritorialSansTéléphone = ÉtablissementTerritorialMédicoSocialViewModelTestFactory.crée(wording, { téléphone: '' })
    ...
    it('pour l’e-mail', () => {
      const établissementTerritorialSansCourriel = ÉtablissementTerritorialMédicoSocialViewModelTestFactory.crée(wording, { courriel: '' })
  ...
  it('affiche l’adresse incomplète lorsqu’il manque des champs d’adresse', () => {
    const établissementTerritorialSansAdresseVoie = ÉtablissementTerritorialMédicoSocialViewModelTestFactory.crée(wording, { adresseVoie: '' })
