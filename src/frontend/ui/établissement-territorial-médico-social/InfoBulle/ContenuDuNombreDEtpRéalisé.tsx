  ...
  return (
    <>
      ...
      <section aria-label={wording.ÉLÉMENTS_DE_COMPRÉHENSION}>
        <p>
          Nombre total d’équivalent temps plein (ETP) réalisé, quelle que soit la catégorie de l’établissement (EHPAD, FAM-SAMSAH, autres etc.)
      ...
      <section aria-label={wording.SOURCES}>
        ...
        <ul>
          <li>
            ERRD annexe 9h_j Tableau des effectifs et des rémunérations
          </li>
          <li>
            CA PA (feuille « Effectifs »)
          </li>
          <li>
            CA PH (feuilles « Tableau des effectifs »)
          </li>
        </ul>
      </section>
