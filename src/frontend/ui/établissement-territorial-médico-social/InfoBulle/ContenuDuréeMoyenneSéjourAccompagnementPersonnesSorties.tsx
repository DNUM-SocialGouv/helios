...
export const ContenuDuréeMoyenneSéjourAccompagnementPersonnesSorties =
  ({ dateDeMiseÀJour, source }: ContenuDuréeMoyenneSéjourAccompagnementPersonnesSortiesProps) => {
      ...
      <>
        ...
        <section aria-label={wording.MODE_DE_CALCUL}>
          <p>
            ...
            Somme des durées d’accompagnement pour les personnes sorties définitivement dans l’année hors personnes en hébergement temporaire et accueil
            de jour (la durée d’accompagnement est l’écart en nombre de jours entre admission et sortie)
            / Nombre de sorties définitives dans l’année hors personnes en hébergement temporaire et accueil de jour
          </p>
        </section>
