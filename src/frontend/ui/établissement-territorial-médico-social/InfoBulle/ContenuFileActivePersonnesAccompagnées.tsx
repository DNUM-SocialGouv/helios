    ...
    <>
      ...
      <section aria-label={wording.ÉLÉMENTS_DE_COMPRÉHENSION}>
        <p>
          ...
          écoulée. L’appellation « personne accompagnée » est le terme actuellement retenu dans les politique sociales et médico-sociales. Cette terminologie
          présente l’avantage de ne pas être stigmatisante et spécialisée (le terme d’accompagnement peut convenir pour un enfant d’ITEP ou un adulte de SESSAD
          ou une personne âgée vivant en établissement ou à domicile).
        </p>
      </section>
