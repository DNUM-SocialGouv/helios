    ...
    <>
      ...
      <section aria-label={wording.ÉLÉMENTS_DE_COMPRÉHENSION}>
        <p>
          ...
          agrégat est positif, cela signifie que l’ESMS dégage des ressources disponibles pour financer d’éventuels besoins liés au court ou moyen terme. A
          l’inverse, un fonds de roulement négatif traduit généralement une situation de déficit financier.
        </p>
      </section>
      ...
      <section aria-label={wording.MODE_DE_CALCUL}>
        ...
        <ul>
          <li>La somme des comptes débiteurs de classes 1 et 2</li>
          <li>La somme des comptes créditeurs de classe 1 et 2, ainsi que les comptes créditeurs 39, 49 et 59</li>
        </ul>
      </section>
