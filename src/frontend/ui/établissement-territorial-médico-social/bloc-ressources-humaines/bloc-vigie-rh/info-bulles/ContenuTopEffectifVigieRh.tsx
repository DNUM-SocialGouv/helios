...
export const ContenuTopEffectifVigieRh = ({ dateDeMiseAJour, dateDonneesArretees }: ContenuVigieRhInfoBulleProps) => {
    ...
    <>
      ...
      <section aria-label={wording.ÉLÉMENTS_DE_COMPRÉHENSION}>
        <p>
          ...
          métiers (Infirmières, auxiliaires de vie, aides-soignants.. ). Les personnes physiques sont identifiées parmi les contrats déclarés par l’établissement en
          DSN,
        </p>
        ...
        <p>La Variation en pourcentage indique l’évolution de l’effectif total par rapport à la même période de l’année précédente, permettant de suivre la tendance d’évolution des effectifs. </p>
      </section>
