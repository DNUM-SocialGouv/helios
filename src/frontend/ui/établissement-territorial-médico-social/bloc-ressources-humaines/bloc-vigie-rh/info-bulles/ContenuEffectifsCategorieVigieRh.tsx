  ...
  return (
    <>
      ...
      <section aria-label={wording.ÉLÉMENTS_DE_COMPRÉHENSION}>
        ...
        <p>Les personnes physiques sont identifiées parmi les contrats déclarés par l’établissement en DSN. Cet indicateur ne tient pas compte du temps de
          travail de chaque poste (ETP).  </p>
