  ...
  return (
    <>
      ...
      <section aria-label={wording.ÉLÉMENTS_DE_COMPRÉHENSION}>
        <p>
          Proportion de CDD terminés, parmi l’ensemble des CDD terminés au cours du dernier   
          trimestre disponible, dont la durée effective est inférieure à six mois. La durée effective  
          correspond au nombre de jours calendaires entre la date de début et la date de fin du   
          contrat, connue avec certitude lorsque le contrat se termine. En cas de rupture anticipée, la   
          date réelle de fin, et non la date prévisionnelle, déclarée lors de la création du contrat, est   
          prise en compte.  
        </p>
      </section>
