  ...
  return (
    <section className="fr-mb-6w">
      ...
      <div className={`fr-alert fr-alert--info fr-mt-10w ${styles["formationAlert"]}`} role="alert">
        ...
        <a className="fr-link fr-text--lg" href="mailto:dnum.helios-support@sg.social.gouv.fr" rel="noreferrer" target="_blank" title="Envoyer un email à dnum.helios-support@sg.social.gouv.fr - ouvre un nouvelle fenêtre">Faites votre demande</a>
      </div>
    </section >
  );
}
