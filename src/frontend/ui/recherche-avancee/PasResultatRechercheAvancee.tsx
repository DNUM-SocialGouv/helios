...
export const PasResultatRechercheAvancee = () => {
    ...
    //TODO add capacite to conditions
    ...
    return (
        <>
            ...
            ) : rechercheAvanceeContext.zoneGeo || rechercheAvanceeContext.typeStructure || rechercheAvanceeContext.statutJuridiqueStructure.length !== 0 ? (
                <div className="fr-mt-5w">
                    {wording.AUCUN_RESULTAT_RECHERCHE_AVANCEE_TEXT}.
                </div>
            ) : (
