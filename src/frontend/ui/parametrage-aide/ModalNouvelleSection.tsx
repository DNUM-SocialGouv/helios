          ...
          <div className="fr-col-12 fr-col-md-6">
            <div className="fr-modal__body">
              ...
              <form className="fr-form fr-p-4w fr-card fr-card--shadow fr-modal__content" onSubmit={surValidation}>
                ...
                <div className="fr-input-group">
                  <label className="fr-label" htmlFor="new-section-icon">
                    <a className="fr-link fr-link--sm" 
                    href="https://www.systeme-de-design.gouv.fr/version-courante/fr/fondamentaux/icone#selection-d-icones" 
                    id="link-icone-dsfr" 
                    rel="noopener external noreferrer" 
                    target="_blank" 
                    title={`Lien vers la liste des icônes du DSFR - ${wording.NOUVELLE_FENÊTRE}`}
                    >
                      {wording.PARAMETRAGE_AIDE_LABEL_ICONE_SECTION}
                    </a>
                  </label>
                  <input
                    className="fr-input"
