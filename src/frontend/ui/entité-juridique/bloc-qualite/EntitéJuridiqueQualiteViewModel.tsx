...
} from "../../../../backend/métier/entities/entité-juridique/EntitéJuridiqueQualite";
...
export class EntitéJuridiqueQualiteViewModel {
  ...
  public get lesDonnéesQualitePasRenseignees(): string[] {
    ...
    if (this.lesQualitesNeSontPasRenseignées) nonRenseignees.push(this.wording.CAPACITÉ_INSTALLÉE_PAR_ACTIVITÉS);
  ...
  public get lesQualitesNeSontPasRenseignées() {
    return !(this.capacites && this.capacites.length > 0);
  }

  public get lesQualitesNeSontPasAutorisées(): boolean {
