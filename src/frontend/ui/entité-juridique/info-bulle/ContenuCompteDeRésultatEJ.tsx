    ...
    <>
      ...
      <section aria-label={wording.ÉLÉMENTS_DE_COMPRÉHENSION}>
        <p>
          ...
          met à la disposition des gestionnaires un système commun de classification de budget qui permet ainsi d’affecter des dépenses à un budget défini. Le
          budget des hôpitaux publics s’organise dans le cadre d’un budget principal (activité hospitalière ou budget H) et, en fonction des activités assurées
          par les établissements, un ou plusieurs budgets annexes.
          <br />
