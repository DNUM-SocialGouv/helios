...
import { CompteDeResultat } from "./AllocationRessources";
...
describe("CompteDeResultat", () => {
  ...
  it("affiche la date de mise à jour du fichier HAPI", () => {
    // WHEN
    renderFakeComponent(<CompteDeResultat entitéJuridiqueBudgetFinanceViewModel={budgetFinanceViewModel} />);

    // THEN
    const dateMiseAJour = graphiqueTest.dateMiseAJour("HAPI", "20/01/2022");
