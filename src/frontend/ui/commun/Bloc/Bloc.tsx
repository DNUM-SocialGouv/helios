...
export const Bloc = ({ children, isMain = false, titre, isExpandable = true, isIdentite = false }: BlocProps) => {
  const contenuBloc = isIdentite ? styles["contenu-bloc-identite"] : styles["contenu-bloc"];
