                    ...
                    <div className="fr-col-12 fr-col-md-8 fr-col-lg-6">
                        <div className="fr-modal__body">
                            ...
                            <div className="fr-modal__content">
                                ...
                                <textarea className={styles["import-textarea"]} placeholder="Le numéro FINESS est composé de 9 caractères alphanumérique. Veuillez saisir un numéro par lingne sans espace, ni ponctuation." rows={10} />
                            </div>
                            <div className="fr-modal__footer">
                                ...
                                <button aria-controls="fr-modal-import-list" className={"fr-btn fr-btn--secondary " + styles["button-position"]} data-fr-opened="false">
                                    Annuler
                                </button>
                            </div>
                        </div>
