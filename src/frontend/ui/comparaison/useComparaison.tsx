  ...
  const tableHeaders = (datesMisAjour: DatesMisAjourSources, structure: string) => {
    if (structure === 'Médico-social')
      ...
      return [
        ...
        { label: "Raison sociale", nomComplet: "Raison sociale", key: "socialReason", sort: true, orderBy: "raison_sociale_courte" },
        { label: "N° FINESS", nomComplet: "N° FINESS", key: "numéroFiness", sort: true, orderBy: "numero_finess" },
        { label: "Nb de séjours Médecine -Total Hospt", nomComplet: "Nb de séjours Médecine -Total Hospt", key: "totalHosptMedecine", info: true, sort: true, orderBy: "total_hospt_medecine" },
        { label: "Nb de séjours Chirurgie -Total Hospt", nomComplet: "Nb de séjours Chirurgie -Total Hospt", key: "totalHosptChirurgie", info: true, sort: true, orderBy: "total_hospt_chirurgie" },
        { label: "Nb de séjours Obstétrique -Total Hospt", nomComplet: "Nb de séjours Obstétrique -Total Hospt", key: "totalHosptObstetrique", info: true, sort: true, orderBy: "total_hospt_obstetrique" },
        { label: "Nb de  journées Psychiatrie - Total Hospt", nomComplet: "Nb de  journées Psychiatrie - Total Hospt", key: "totalHosptPsy", info: true, sort: true, orderBy: "total_hospt_ssr" },
        { label: "Nb de journées  SSR- Total Hospt", nomComplet: "Nb de journées  SSR- Total Hospt", key: "totalHosptSsr", info: true, sort: true, orderBy: "total_hospt_psy" },
        ...
        { label: "Nb de séjours HAD", nomComplet: "Nb de séjours HAD", key: "sejoursHad", info: true, sort: true, orderBy: "nombre_sejours_had" },
        { label: "Nb de journées USLD", nomComplet: "Nb de journées USLD", key: "journeesUsld", info: true, sort: true, orderBy: "nombre_journees_usld" },
        { label: topEnveloppes[0], nomComplet: topEnveloppes[0], key: 'enveloppe1', info: true, sort: true, orderBy: "enveloppe_1" },
        { label: topEnveloppes[1], nomComplet: topEnveloppes[1], key: 'enveloppe2', info: true, sort: true, orderBy: "enveloppe_2" },
        { label: topEnveloppes[2], nomComplet: topEnveloppes[2], key: 'enveloppe3', info: true, sort: true, orderBy: "enveloppe_3" },
      ]
