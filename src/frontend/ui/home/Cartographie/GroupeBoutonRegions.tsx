...
export const GroupeBoutonRegions = () => {
  ...
  return (
    <ul className="fr-btns-group fr-btns-group--inline-reverse fr-btns-group--inline-lg">
      ...
      <li>
        <select className="fr-btn" defaultValue="" onChange={handleOnChangeOutreMerRegions} title='Cartes Outre-mer'>
          <option disabled hidden value="">{régions["outre-mer"].label}</option>
