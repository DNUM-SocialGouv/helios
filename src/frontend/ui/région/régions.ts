...
const LIEN_ARS2_GUYANE = "https://carto.atlasante.fr/1/helios_outremer.map?object=R%C3%A9gion;insee_reg;03";
const LIEN_ARS3_LA_REUNION = "https://carto.atlasante.fr/1/helios_outremer.map?object=R%C3%A9gion;insee_reg;04";
const LIEN_ARS4_MATINIQUE = "https://carto.atlasante.fr/1/helios_outremer.map?object=R%C3%A9gion;insee_reg;02";
const LIEN_ARS5_MAYOTTE = "https://carto.atlasante.fr/1/helios_outremer.map?object=R%C3%A9gion;insee_reg;06";
