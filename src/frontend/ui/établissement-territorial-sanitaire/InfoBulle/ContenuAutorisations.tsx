    ...
    <>
      ...
      <section aria-label={wording.ÉLÉMENTS_DE_COMPRÉHENSION}>
        <p>
          ...
          permettant à un établissement de santé d’exercer une activité de soins spécifique (chirurgie, médecine, psychiatrie, etc.) conformément aux conditions d’implantation et de fonctionnement prévues dans le Code de la santé publique.
        </p>
        <p>
          Dans le domaine sanitaire, les autorisations sont délivrées à une entité juridique pour une mise en œuvre au sein d’un établissement géographique.
          Seules les autorisations mises en œuvre sont actuellement affichées.
        </p>
        <p>
        ...
        <p>La transition vers ce nouveau format s’effectue progressivement au fil des nouvelles autorisations. Aussi, les deux formats peuvent temporairement coexister.</p>
      </section>
