    ...
    <>
      ...
      <section aria-label={wording.ÉLÉMENTS_DE_COMPRÉHENSION}>
        <p>
          ...
          composé des éléments suivants : Activité/Modalité/Forme. Une activité soumise à reconnaissance contractuelle est une activité non soumise à
          autorisation du DG ARS mais soumise à reconnaissance contractuelle dans le cadre et la durée du CPOM (contrat pluriannuel d’objectif et de moyens).
        </p>
      </section>
