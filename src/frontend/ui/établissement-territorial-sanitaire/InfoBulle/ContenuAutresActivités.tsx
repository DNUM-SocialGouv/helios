    ...
    <>
      ...
      <section aria-label={wording.ÉLÉMENTS_DE_COMPRÉHENSION}>
        <p>
          ...
          composé des éléments suivants : Activité/Modalité/Forme. Les autres activités de soins sont soumises à l’autorisation du Directeur Général (DG) de
          l’ARS selon des modalités et des durées différentes particulières.
        </p>
      </section>
      ...
      {estEntitéJuridique && (
        <section aria-label={wording.MODE_DE_CALCUL}>
          <p>
            <span className="fr-text--bold">Mode de calcul :</span> Les autorisations et capacités affichées au niveau de l’entité juridique (EJ) correspondent à l’ensemble des autorisations et capacités des
