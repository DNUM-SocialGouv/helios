...
import { BlocRessourcesHumainesEtablissementSanitaire } from "./BlocRessourcesHumainesEtablissementSanitaire";
...
describe("La page établissement sanitaire - bloc ressources humaines", () => {
  ...
  const indiceDeLIndicateur: Record<keyof EtablissementTerritorialSanitaireRH, number> = {
    annee: -1,
    nombreEtpPm: 0,
    nombreEtpPnm: 1,
    depensesInterimPm: 2,
