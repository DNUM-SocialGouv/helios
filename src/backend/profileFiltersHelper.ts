...
const filterIdentiteMedicoSocial = (identite: any, profil: any) => {
    const filtredIdentite = {
        adresseAcheminement: profil.adresse === 'ok' ? identite.adresseAcheminement : '',
        adresseNuméroVoie: profil.adresse === 'ok' ? identite.adresseNuméroVoie : '',
        adresseTypeVoie: profil.adresse === 'ok' ? identite.adresseTypeVoie : '',
        adresseVoie: profil.adresse === 'ok' ? identite.adresseVoie : '',
        catégorieÉtablissement: profil.catégorieÉtablissement === 'ok' ? identite.catégorieÉtablissement : '',
        codeModeTarification: profil.modeTarification === 'ok' ? identite.codeModeTarification : '',
        courriel: profil.télEtEmail === 'ok' ? identite.courriel : '',
        dateDEntréeEnVigueurDuCpom: profil.dateDEntréeEnVigueurDuCpom === 'ok' ? identite.dateDEntréeEnVigueurDuCpom : '',
        libelléCatégorieÉtablissement: profil.catégorieÉtablissement === 'ok' ? identite.libelléCatégorieÉtablissement : '',
        libelléModeTarification: profil.modeTarification === 'ok' ? identite.libelléModeTarification : '',
        numéroFinessEntitéJuridique: profil.EJ_rattachement === 'ok' ? identite.numéroFinessEntitéJuridique : '',
        numéroFinessÉtablissementPrincipal: profil.ET_principal_secondaire === 'ok' ? identite.numéroFinessÉtablissementPrincipal : '',
        numéroFinessÉtablissementTerritorial: profil.numéroFiness === 'ok' ? identite.numéroFinessÉtablissementTerritorial : '',
        raisonSociale: profil.nom === 'ok' ? identite.raisonSociale : '',
        raisonSocialeCourte: profil.nom === 'ok' ? identite.raisonSocialeCourte : '',
        siret: profil.siret === 'ok' ? identite.siret : '',
        typeÉtablissement: profil.ET_principal_secondaire === 'ok' ? identite.typeÉtablissement : '',
        téléphone: profil.télEtEmail === 'ok' ? identite.téléphone : '',
        raisonSocialeDeLEntitéDeRattachement: profil.EJ_rattachement === 'ok' ? identite.raisonSocialeDeLEntitéDeRattachement : '',
        statutJuridique: profil.statut_EJ === 'ok' ? identite.statutJuridique : '',
        estMonoÉtablissement: profil.estMonoÉtablissement === 'ok' ? identite.estMonoÉtablissement : '',
    }
    return filtredIdentite;
}
