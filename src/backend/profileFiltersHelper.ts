...
const filterIdentiteSanitaire = (identite: any, profil: any) => {
  const filtredIdentite = {
    ...
    numéroFinessÉtablissementPrincipal:
      profil.ET_principal_secondaire === "ok" ? identite.numéroFinessÉtablissementPrincipal : { dateMiseÀJourSource: "", value: "" },
    ...
    raisonSocialeDeLEntitéDeRattachement:
      profil.EJ_rattachement === "ok" ? identite.raisonSocialeDeLEntitéDeRattachement : { dateMiseÀJourSource: "", value: "" },
