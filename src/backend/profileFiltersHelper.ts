...
const filterActiviteMedicoSocial = (activites: any, profil: any) => {
  for (const activite of activites) {
    ...
    activite.tauxOccupationExternat = profil.tauxOccupationExternat === "ok" ? activite.tauxOccupationExternat : { value: "" };
    activite.tauxOccupationSemiInternat = profil.tauxOccupationSemiInternat === "ok" ? activite.tauxOccupationSemiInternat : { value: "" };
    activite.tauxOccupationInternat = profil.tauxOccupationInternat === "ok" ? activite.tauxOccupationInternat : { value: "" };
    activite.tauxOccupationAutre = profil.tauxOccupationAutre === "ok" ? activite.tauxOccupationAutre : { value: "" };
    activite.tauxOccupationSeances = profil.tauxOccupationSeances === "ok" ? activite.tauxOccupationSeances : { value: "" };
  }
  return activites;
};
