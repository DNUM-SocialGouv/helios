...
export interface MessageAccueilLoader {
  save(contenu: string, dateDebut: string, dateFin: string | null, badgeType: string | null, badgeLibelle: string | null, lienUrl: string | null, lienLibelle: string | null): Promise<void>;
