...
import { ÉtablissementTerritorialMédicoSocialQualite } from "../entities/établissement-territorial-médico-social/ÉtablissementTerritorialMédicoSocialQualite";
...
export interface ÉtablissementTerritorialMédicoSocialLoader {
  ...
  chargeQualite(numéroFinessÉtablissementTerritorial: string): Promise<ÉtablissementTerritorialMédicoSocialQualite[]>;
