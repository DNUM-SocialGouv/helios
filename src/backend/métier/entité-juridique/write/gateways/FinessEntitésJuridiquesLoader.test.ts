...
import { NodeXmlToJs } from '../../../../technique/shared/gateways/xml-to-js/NodeXmlToJs'
...
describe('Récupération des entités juridiques de la source de données FINESS', () => {
  const localPath = `${fakeBackendDependencies.environmentVariables.SFTP_LOCAL_PATH}/fake_finess`
