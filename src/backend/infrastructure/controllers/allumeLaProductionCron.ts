...
async function allumeLaProductionCron(dependencies: Dependencies): Promise<void> {
  ...
  try {
    ...
    dependencies.logger.info("La production est allumée.");
  } catch (error) {
    dependencies.logger.error(error);
  }
}

allumeLaProductionCron(dependencies);
