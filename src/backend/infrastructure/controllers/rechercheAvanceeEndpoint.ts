...
export async function rechercheAvanceeParmiLesEntitésEtÉtablissementsEndpoint(dependencies: Dependencies, terme: string, commune: string, type: string, statutJuridique: string[], page: number): Promise<RésultatDeRecherche> {
    try {
