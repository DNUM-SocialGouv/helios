...
describe("La recherche avancée d’entités et d’établissements", () => {
  ...
  it("par terme de recherche et commune", async () => {
    ...
    // WHEN
    const params = { terme: termeRecherche, zone: communeRecherche, zoneD: departementRecherche, typeZone: "C", type: [], statutJuridique: [], categories: [], capaciteSMS: [], orderBy: "", order: "ASC", page: premièrePage, forExport: false } as ParametreDeRechercheAvancee;
  ...
  it("par terme de recherche et département", async () => {
    ...
    // WHEN
    const params = { terme: termeRecherche, zone: departementRecherche, zoneD: "", typeZone: "D", type: [], statutJuridique: [], categories: [], capaciteSMS: [], orderBy: "", order: "ASC", page: premièrePage, forExport: false } as ParametreDeRechercheAvancee;
    const rechercheAvancee = await typeOrmRechercheLoader.rechercheAvancee(params);
  ...
  it("par terme de recherche et région", async () => {
    ...
    // WHEN
    const params = { terme: termeRecherche, zone: regionRecherche, zoneD: "", typeZone: "R", type: [], statutJuridique: [], categories: [], capaciteSMS: [], orderBy: "", order: "ASC", page: premièrePage, forExport: false } as ParametreDeRechercheAvancee;
    const rechercheAvancee = await typeOrmRechercheLoader.rechercheAvancee(params);
  ...
  it("par terme de recherche, commune et structure", async () => {
    ...
    // WHEN
    const params = { terme: termeRecherche, zone: communeRecherche, zoneD: departementRecherche, typeZone: "C", type: ["Médico-social"], statutJuridique: [], categories: [], capaciteSMS: [], orderBy: "", order: "ASC", page: premièrePage, forExport: false } as ParametreDeRechercheAvancee;
    const rechercheAvancee = await typeOrmRechercheLoader.rechercheAvancee(params);
  ...
  it("par commune et structure", async () => {
    ...
    // WHEN
    const params = { terme: "", zone: communeRecherche, zoneD: departementRecherche, typeZone: "C", type: ["Médico-social"], statutJuridique: [], categories: [], capaciteSMS: [], orderBy: "", order: "ASC", page: premièrePage, forExport: false } as ParametreDeRechercheAvancee;
    const rechercheAvancee = await typeOrmRechercheLoader.rechercheAvancee(params);
  ...
  it("par terme de recherche, commune , structure et type", async () => {
    ...
    // WHEN
    const params = { terme: termeRecherche, zone: communeRecherche, zoneD: departementRecherche, typeZone: "C", type: ["Entité juridique"], statutJuridique: ["prive_lucratif"], categories: [], capaciteSMS: [], orderBy: "", order: "ASC", page: premièrePage, forExport: false } as ParametreDeRechercheAvancee;
    const rechercheAvancee = await typeOrmRechercheLoader.rechercheAvancee(params);
  ...
  it("par terme de recherche, structure et type", async () => {
    ...
    // WHEN
    const params = { terme: termeRecherche, zone: "", zoneD: "", typeZone: "", type: ["Entité juridique"], statutJuridique: ["prive_lucratif"], categories: [], capaciteSMS: [], orderBy: "", order: "ASC", page: premièrePage, forExport: false } as ParametreDeRechercheAvancee;
    const rechercheAvancee = await typeOrmRechercheLoader.rechercheAvancee(params);
  ...
  it("par commune  et capacité", async () => {
    ...
    const params = { terme: "", zone: communeRecherche, zoneD: departementRecherche, typeZone: "C", type: [], statutJuridique: [], categories: [], capaciteSMS, orderBy: "", order: "ASC", page: premièrePage, forExport: false } as ParametreDeRechercheAvancee;
    const rechercheAvancee = await typeOrmRechercheLoader.rechercheAvancee(params);
