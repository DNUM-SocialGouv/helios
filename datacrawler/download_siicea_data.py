...
def main() -> None:
    """Script pour télécharger les données brutes SIICEA depuis un serveur SFTP.
    ...
    le fichier le plus récent avec le préfixe 'siicea_', le télécharge dans
    ...
    remote_path = "SIICEA"
    local_path = Path(variables_d_environnement["SIICEA_DATA_PATH"])
    file_prefix = "siicea_"
    ...
    try:
        ...
        try:
            entries = list_siicea_files(sftp, remote_path, file_prefix)
