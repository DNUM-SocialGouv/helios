...
class TestExtraisLaDateDuNomDeFichier:
    def test_extrais_la_date_du_nom_de_fichier_diamant(self) -> None:
        # GIVEN
        chemin_du_fichier = "data_test/entrée/diamant/ANN_ERRD_EJ_ET_2022_06_07.CSV"
    ...
    def test_extrais_la_date_du_nom_de_fichier_finess(self) -> None:
        # GIVEN
        chemin_du_fichier = "data_test/entrée/flux_finess/enrichi/finess_cs1400105_stock_20220816-0449.xml"
