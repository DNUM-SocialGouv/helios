...
from datacrawler.test_helpers.config_path import ROOT_DIR


class TestLisLeFichierCsv:
    def test_lis_les_colonnes_demandées_du_fichier_csv_ann_errd_ej_et(self) -> None:
        # GIVEN
        chemin_du_fichier = os.path.join(ROOT_DIR, "data_set/diamant/ANN_ERRD_EJ_ET_2022_06_07.CSV")
    ...
    def test_lis_les_colonnes_demandées_du_fichier_csv_ann_ms_tdp(self) -> None:
        # GIVEN
        chemin_du_fichier = os.path.join(ROOT_DIR, "data_set/diamant/ANN_MS_TDP_ET_2022_06_07.CSV")
    ...
    def test_lis_les_colonnes_demandées_du_fichier_csv_men_pmsi_annuel(self) -> None:
        # GIVEN
        chemin_du_fichier = os.path.join(ROOT_DIR, "data_set/diamant/MEN_PMSI_ANNUEL_2022_06_07.CSV")
    ...
    def test_lis_les_colonnes_demandées_du_fichier_csv_ann_rpu(self) -> None:
        # GIVEN
        chemin_du_fichier = os.path.join(ROOT_DIR, "data_set/diamant/ANN_RPU_2022_06_23.CSV")
    ...
    def test_lis_les_colonnes_demandées_du_fichier_ann_sae(self) -> None:
        # GIVEN
        chemin_du_fichier = os.path.join(ROOT_DIR, "data_set/diamant/ANN_SAE_2022_08_03.CSV")
    ...
    def test_lis_les_colonnes_du_bloc_ressources_humaines_du_fichier_ann_ca_ej_et(self) -> None:
        # GIVEN
        chemin_du_fichier = os.path.join(ROOT_DIR, "data_set/diamant/ANN_CA_EJ_ET_2022_09_01.CSV")
