...
import datacrawler
from datacrawler.load.nom_des_tables import TABLES_DES_RESSOURCES_HUMAINES_ETABLISSEMENT_SANITAIRE, TABLE_DES_MISES_À_JOUR_DES_FICHIERS_SOURCES, FichierSource
...
from datacrawler.ajoute_le_bloc_ressources_humaines_des_etablissements_sanitaires import ajoute_le_bloc_ressources_humaines_des_etablissement_sanitaires
...
class TestAjouteBlocRessourcesHumainesEtablissementSanitaire:
    ...
    def test_savegarde_les_donnees_des_ressources_humaines(self) -> None:
        ...
        ajoute_le_bloc_ressources_humaines_des_etablissement_sanitaires(chemin_du_fichier_quo_san_finance, base_de_données_test, mocked_logger)
        ...
        donnees_ressources_humaines_enregistrees = pd.read_sql(TABLES_DES_RESSOURCES_HUMAINES_ETABLISSEMENT_SANITAIRE, base_de_données_test)
    ...
    def test_supression_donnees_existantes_avant_insertion_des_nouvelles(self) -> None:
        ...
        donnees_avant_suppression = pd.read_sql(TABLES_DES_RESSOURCES_HUMAINES_ETABLISSEMENT_SANITAIRE, base_de_données_test)
    ...
    def test_revient_a_la_situation_initiale_si_l_ecriture_des_indicateurs_ressources_humaines_echoue(self, mocked_sauvegarde: Mock) -> None:
        ...
        pd.testing.assert_frame_equal(donnees_ressources_humaines_enregistrees.sort_index(axis=1), donnees_table_ressources_humaines_etsan.sort_index(axis=1))
