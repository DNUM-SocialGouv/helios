        ...
        capacités = pd.DataFrame(
            {
                ...
                "nombre_places_médecine": [1.0, 2.0, 5.0],
        ...
        agrégation_capacités_attendues = pd.DataFrame(
            {
                ...
                "nombre_lits_chirurgie": [3.0, 5.0],
                "nombre_lits_médecine": [3.0, 5.0],
                "nombre_lits_obstétrique": [3.0, 5.0],
                "nombre_lits_ssr": [3.0, 5.0],
                "nombre_places_chirurgie": [3.0, 5.0],
                "nombre_places_médecine": [3.0, 5.0],
                "nombre_places_obstétrique": [3.0, 5.0],
                "nombre_places_ssr": [3.0, 5.0],
                "nombre_lits_usld": [3.0, 5.0],
                "nombre_lits_ou_places_psy_complet": [3.0, 5.0],
                "nombre_places_psy_partiel": [3.0, 5.0],
            }
        )
