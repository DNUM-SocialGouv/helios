...
class TestAjouteLesActivitésDesÉtablissementsMedicoSociaux:
    ...
    def test_sauvegarde_les_données_dans_une_table_vide(self) -> None:
        ...
        # WHEN
        ajoute_les_activités_des_établissements_médico_sociaux(chemin_du_fichier_ann_errd_ej_et,
                                                               chemin_du_fichier_ann_ms_tdp_et, base_de_données_test,
                                                               logger)
        ...
        data_frame_attendu = pd.DataFrame(
            {
                ...
                "numero_finess_etablissement_territorial": ["010001261", "010003598", "010786259", "010001261",
                                                            "010003598", "010789717", "010003598"],
                "taux_occupation_accueil_de_jour": [NaN, 0.4801282051282051, 0.8486301369863014, NaN,
                                                    0.3615384615384615, NaN, 0.3397435897435897],
                ...
                "taux_occupation_en_hebergement_permanent": [NaN, 0.99779299847793, 0.9953224189776144, NaN,
                                                             0.9324506094997898, NaN, 0.9902397260273972],
                ...
                "duree_moyenne_sejour_accompagnement_personnes_sorties": [6008.33, 2359.81, NaN, 5729.5, 2226.21, NaN,
                                                                          NaN],
            }
        )
