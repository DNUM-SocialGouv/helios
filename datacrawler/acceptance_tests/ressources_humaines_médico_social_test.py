        ...
        données_ressources_humaines_attendues = pd.DataFrame(
            {
                ...
                "annee": [2019, 2018, 2021, 2020, 2019, 2018, 2019],
                "nombre_cdd_remplacement": [2.0, 19.0, 5.0, 5.0, 5.0, 5.0, NaN],
                "taux_etp_vacants": [0.1197, 0.0483, 0.0, 0.0, 0.0, 0.0, NaN],
                "taux_prestation_externes": [0.0232, NaN, 0.0164, 0.0164, 0.0082, 0.0164, NaN],
                "taux_rotation_personnel": [0.1923, 0.1429, 0.0352, 0.0352, 0.0141, 0.0352, NaN],
                "taux_absenteisme_maladie_courte_duree": [0.0028, 0.0012, 0.0083, 0.0083, 0.0125, 0.0083, NaN],
                "taux_absenteisme_maladie_moyenne_duree": [0.0465, 0.0717, 0.0166, 0.0166, 0.0149, 0.0166, NaN],
                "taux_absenteisme_maladie_longue_duree": [0.0, .1194, 0.0089, 0.0089, 0.0319, 0.0089 , NaN],
                ...
                "nombre_etp_realises": [NaN, NaN, 188.49999999999997, 50.649999999999991, 17.190000000000001, NaN, 9.7100000000000009],
            },
        )
        ...
        données_ressources_humaines_attendues = pd.DataFrame(
            {
                ...
                "taux_absenteisme_maladie_courte_duree": [0.0028, 0.0012, 0.0083, 0.0083, 0.0125, 0.0083],
                ...
                "nombre_etp_realises": [NaN, NaN, 188.49999999999997, 50.649999999999991, 17.190000000000001, NaN],
            }
        )
