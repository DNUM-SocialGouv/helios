...
class TestAjouteLeBlocDesRessourcesHumainesMédicoSocial:
        ...
        données_ressources_humaines_attendues = pd.DataFrame(
            {
                ...
                "nombre_cdd_remplacement": [2, 19, 5, 5, 5, 5],
                "taux_etp_vacants": [
                    0.1197,
                    0.0483,
                    0.0,
    ...
    def test_sauvegarde_les_dates_de_mises_à_jour_des_indicateurs_ressources_humaines(self) -> None:
        ...
        assert date_du_fichier_ann_errd_ej_et.fetchone() == (date(2022, 6, 7), FichierSource.DIAMANT_ANN_MS_TDP_ET.value)
    ...
    def test_revient_à_la_situation_initiale_si_l_écriture_des_indicateurs_budget_et_finances_échoue(self, mocked_sauvegarde: Mock) -> None:
        ...
        assert date_du_fichier_ann_errd_ej_et.fetchone() == (date(2020, 1, 1), FichierSource.DIAMANT_ANN_MS_TDP_ET.value)
