...
class TestImportVigiePprofessionFiliere:
    ...
    def test_import_vigie_rh_profession_filiere_test(self) -> None:
        ...
        chemin_local_du_fichier_profession_filiere = os.path.join(
            vegie_rh_data_path, trouve_le_nom_du_fichier(fichiers, FichierSource.VIGIE_RH_PROFESSION_FILIERE.value, mocked_logger)
        )
        ...
        chemin_local_du_fichier_ref = os.path.join(
            vegie_rh_data_path, trouve_le_nom_du_fichier(fichiers, FichierSource.VIGIE_RH_REF_PROFESSION_FILIERE.value, mocked_logger)
        )
        ...
        with base_de_données_test.begin() as connection:
            inserer_nouvelles_donnees(
                TABLE_REF_PROFESSION_FILIERE, connection, SOURCE, df_ref, mocked_logger, FichierSource.VIGIE_RH_REF_PROFESSION_FILIERE, date_de_mise_à_jour_ref
            )
