...
archive_de_donnees__amm_arghos = os.path.join("data_test", "entrée", "flux_finess", "enrichi", "amm_arhgos_20250812-0238.xml.gz")
fichier_de_donnees_amm_arghos = os.path.join("data_test", "entrée", "flux_finess", "enrichi", "amm_arhgos_20250812-0238.xml")
