...
def import_etablissements_territoriaux(chemin_local_du_fichier_et: str, chemin_local_du_fichier_categorie: str, base_de_donnees: Engine, logger: Logger) -> None:
    ...
    etablissements_territoriaux_sauvegardes = recupere_les_numeros_finess_des_etablissements_de_la_base(base_de_donnees)
    etablissements_territoriaux_a_supprimer = extrais_les_etablissements_territoriaux_recemment_fermes(etablissements_territoriaux_ouverts,
                                                                                               etablissements_territoriaux_sauvegardes)
    ...
    etablissements_territoriaux_avec_code_region = associe_le_code_region(etablissements_territoriaux_categorises, referentiel_dep_region)
    ...
    print(etablissements_territoriaux_transformes)
    ...
    #     supprime(connection, TABLE_ENTITES_JURIDIQUES, CLE_PRIMAIRE_TABLE_ENTITES_JURIDIQUES, etablissements_territoriaux_a_supprimer)
    #     logger.info(f"Supprime {len(etablissements_territoriaux_a_supprimer)} entités juridiques.")
