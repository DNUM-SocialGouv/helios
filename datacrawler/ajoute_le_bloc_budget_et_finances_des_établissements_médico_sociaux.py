...
def ajoute_le_bloc_budget_et_finances_des_établissements_médico_sociaux(
    chemin_du_fichier_ann_errd_ej_et: str, chemin_du_fichier_ann_ca_ej_et: str, base_de_données: Engine, logger: Logger
) -> None:
    ...
    budget_et_finances_des_établissements_médico_sociaux = fusionne_les_données_des_établissements_errd_et_ca(
    ...
    with base_de_données.begin() as connection:
        écrase_et_sauvegarde_les_données_avec_leur_date_de_mise_à_jour(
            ...
            [(FichierSource.DIAMANT_ANN_ERRD_EJ_ET, date_du_fichier_ann_errd_ej_et), (FichierSource.DIAMANT_ANN_CA_EJ_ET, date_du_fichier_ann_ca_ej_et)],
            logger,
        )
