...
def ajoute_le_bloc_ressources_humaines_des_établissements_médico_sociaux(
    ...
    logger.info("[DIAMANT] Récupère les nombres d'ETP réalisés des établissements médico-sociaux sous cadre ERRD")
    données_ann_errd_ej_et = lis_le_fichier_csv(
        chemin_du_fichier_ann_errd_ej_et,
        colonnes_à_lire_bloc_ressources_humaines_ann_errd_ej_et,
        extrais_l_equivalence_des_types_des_colonnes(équivalences_diamant_ann_errd_ej_et_ressources_humaines_helios),
    )
    ...
    logger.info("[DIAMANT] Récupère les nombres d'ETP réalisés des établissements médico-sociaux sous cadre CA")
    données_ann_ca_ej_et = lis_le_fichier_csv(
        chemin_du_fichier_ann_ca_ej_et,
        colonnes_à_lire_bloc_ressources_humaines_ann_ca_ej_et,
        extrais_l_equivalence_des_types_des_colonnes(équivalences_diamant_ann_ca_ej_et_ressources_humaines_helios),
    )
