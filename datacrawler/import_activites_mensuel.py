...
def import_activites_mensuels(donnees_activites_mensuel_filtrees: pd.DataFrame, base_de_données: Engine, chemin_local_du_fichier_men_pmsi_mencumu: str,logger: Logger) -> None :
