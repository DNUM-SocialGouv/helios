...
def transforme_les_donnees_allocation_ressource_ej(
    ...
    est_dans_finess = donnees_allocation_ressource_filtrees["ID_BENEFICIAIRE"].isin(numéros_finess_des_entites_juridiques_connues["numero_finess_entite_juridique"])
...
def transforme_les_donnees_allocation_ressource_et(
    ...
    donnees_allocation_ressource_filtrees = donnees_allocation_ressource[donnees_allocation_ressource['TYPE_BENEFICIAIRE'].apply(filter_type_beneficiaire)]
    est_dans_finess = donnees_allocation_ressource_filtrees["ID_BENEFICIAIRE"].isin(numéros_finess_des_établissements_connus["numero_finess_etablissement_territorial"])
