...
def transforme_les_donnees_ressources_humaines(
    ...
    donnees_dernieres_5_annees = filtre_les_données_sur_les_n_dernières_années(
                                    donnees_quo_san_finance, 
                                    NOMBRE_D_ANNEES_RESSOURCES_HUMAINE)
    return (
...
def extrais_les_donnees(data: pd.DataFrame) -> pd.DataFrame:
    ...
    mask = (
        data_frame.index.get_level_values("numero_finess_etablissement_territorial").notna()
