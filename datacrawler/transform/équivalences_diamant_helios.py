...
équivalences_diamant_men_pmsi_mensumu_helios: ÉquivalencesDiamantHelios = {
    ...
    "Nombre de séjours mensuels Obstétrique": ColonneHelios(nom="nombre_sejours_complets_obstetrique", type=str),
    "Nombre de séjours mensuels HTP/AMBU Médecine": ColonneHelios(nom="nombre_sejours_partiels_medecine", type=str),
...
équivalences_engagements_starsfir_allocation_ressource_ej_helios: ÉquivalencesDiamantHelios = {
    ...
    COLONNE_SOURCE_MODE_DELEGATION_ENGAGEMENTS: ColonneHelios(nom="mode_delegation", type=str),
