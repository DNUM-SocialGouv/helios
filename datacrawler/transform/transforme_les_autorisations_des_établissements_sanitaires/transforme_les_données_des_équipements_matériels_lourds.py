...
def transforme_les_données_des_équipements_matériels_lourds(
    données_finess_des_équipements_matériels_lourds: pd.DataFrame, numéros_finess_des_établissements_connus: pd.DataFrame, logger: Logger
) -> pd.DataFrame:
    est_dans_finess = données_finess_des_équipements_matériels_lourds["nofinesset"].isin(
    ...
    return (
        données_finess_des_équipements_matériels_lourds[est_dans_finess][colonnes_à_garder_finess_cs1400104]
