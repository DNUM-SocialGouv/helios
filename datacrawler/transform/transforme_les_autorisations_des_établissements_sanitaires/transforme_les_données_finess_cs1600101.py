...
def transforme_les_données_finess_cs1600101(
    données_finess_cs1600101: pd.DataFrame, numéros_finess_des_établissements_connus: pd.DataFrame, logger: Logger
) -> pd.DataFrame:
    est_dans_finess = données_finess_cs1600101["nofinesset"].isin(numéros_finess_des_établissements_connus["numero_finess_etablissement_territorial"])
    ...
    return (
        données_finess_cs1600101[est_dans_finess][colonnes_à_garder_finess_cs1600101]
