...
def import_inspections_controles(chemin_local_du_fichier_siicea: str, base_de_données: Engine, logger: Logger) -> None:
    ...
    date_du_fichier_siicea = extrais_la_date_du_nom_de_fichier_sirec_sivss(chemin_local_du_fichier_siicea)
...
if __name__ == "__main__":
    ...
    chemin_local_du_fichier_siicea = os.path.join(
        siicea_data_path, trouve_le_nom_du_fichier_sirec_sivss(fichiers, "siicea", logger_helios)
    )
