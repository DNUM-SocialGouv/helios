...
La recherche est le point d'entrée principal d'Helios. Elle permet aux utilisateurs de retrouver rapidement les établissements sanitaires, médico-sociaux et les entités juridiques dont ils ont besoin pour leur pilotage territorial.

Cette section détaille les différentes fonctionnalités de recherche disponibles dans Helios :

- **Recherche simple et avancée** : moteurs de recherche permettant de retrouver des structures via différents critères (nom, FINESS, localisation, typologie, activités, capacités).
